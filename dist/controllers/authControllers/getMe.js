...
var GetMe = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 4, , 5]);
                userData = jsonwebtoken_1.default.verify(token, 'secret');
                if (!userData) return [3 /*break*/, 3];
                return [4 /*yield*/, (0, getMe_1.GetMeService)(userData.id)];
            case 2:
                user = _a.sent();
