...
var RegistrationService = function (name, email, enteredPassword) { return __awaiter(void 0, void 0, void 0, function () {
    var candidate, registrationDate, loginDate, password, user, userDto, tokens;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                ...
                tokens = (0, generateTokens_1.GenerateTokensService)(__assign(__assign({}, userDto), { status: 'active' }));
