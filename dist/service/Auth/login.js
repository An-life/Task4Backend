...
var LoginService = function (email, password) { return __awaiter(void 0, void 0, void 0, function () {
    var user, loginDate, isPassEquals, userDto, tokens;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, user_1.User.findOne({ email: email }).select('password').select('status')];
            case 1:
                user = _a.sent();
                loginDate = new Date();
                if (!user) return [3 /*break*/, 3];
                return [4 /*yield*/, user_1.User.updateOne({ email: email }, { loginDate: loginDate })];
            case 2:
                _a.sent();
                _a.label = 3;
            case 3:
                if (!user) {
                    throw apiError_1.ApiError.BadRequest('User with this email is not found');
                }
                if (!user.password) {
                    throw apiError_1.ApiError.BadRequest('Password is not correct');
                }
            ...
            case 4:
                ...
                tokens = (0, generateTokens_1.GenerateTokensService)(__assign({}, userDto));
